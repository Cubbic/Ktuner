...
class MainFrame(wx.Frame):
    def __init__(self, *args, **kwds):
        ...
        self.hz = wx.StaticText(self, wx.ID_ANY, _("0"), style=wx.ALIGN_CENTRE)
    ...
    def __set_properties(self):
        ...
        self.hz.SetBackgroundColour(wx.SystemSettings_GetColour(wx.SYS_COLOUR_WINDOWFRAME))
        self.hz.SetFont(wx.Font(20, wx.SWISS, wx.NORMAL, wx.NORMAL, 0, ""))
        # end wxGlade
    ...
    def __do_layout(self):
        ...
        sizer.Add(self.hz, 0, wx.ALIGN_CENTER_HORIZONTAL, 0)
